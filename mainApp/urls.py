...
from .views import HomePageView,AboutPageView,ProductDetailView,CartPageView,add_cart,CartDeleteView
...
urlpatterns = [
    ...
    path('deleteCart/<int:pk>',CartDeleteView.as_view(),name='deleteCart')
